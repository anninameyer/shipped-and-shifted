...
otu_file <- "/Users/meyeanni/Desktop/git_sourdough/SourdoughFlow/LP4/shipping_analysis/shipping_data/16S/OTUs/alpha_rarefaction/core-metrics-results-380/20250513_relative_features_OTU_species_names.csv"        # samples x species (relative or counts)
metadata_file <- "/Users/meyeanni/Desktop/git_sourdough/SourdoughFlow/LP4/shipping_analysis/shipping_data/20250513_16S_shipping_general_metadata_all_samples_with_alpha_diversity_color_scheme.csv"    # samples x metadata (sample_id as row names)
...
write.csv(res$res, file = "/Users/meyeanni/Desktop/git_sourdough/SourdoughFlow/LP4/shipping_analysis/shipping_data/Stats/ancombc2_main_results_temperature_group_16S.csv")
write.csv(res$res_pair, file = "/Users/meyeanni/Desktop/git_sourdough/SourdoughFlow/LP4/shipping_analysis/shipping_data/Stats/ancombc2_pairwise_results_temp_group_16S.csv")
write.csv(res$res_global, file = "/Users/meyeanni/Desktop/git_sourdough/SourdoughFlow/LP4/shipping_analysis/shipping_data/Stats/ancombc2_global_results_temp_group_16S.csv")
write.csv(res$samp_frac, file = "/Users/meyeanni/Desktop/git_sourdough/SourdoughFlow/LP4/shipping_analysis/shipping_data/Stats/ancombc2_sample_fractions_temp_group_16S.csv")
